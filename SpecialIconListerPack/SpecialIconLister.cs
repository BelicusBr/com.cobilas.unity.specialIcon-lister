...
public static class SpecialIconLister
{
    ...
    static void GetSpecialIcons()
    {
        ...
        using (StreamWriter file = File.CreateText(Path.Combine(Application.dataPath, "Resources\\specialIconList.txt")))
            file.Write(specialIcon);
    }
